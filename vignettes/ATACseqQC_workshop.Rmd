...
knitr::include_graphics(system.file('vignettes', 'Fig.1.png', package = 'ATACseqQCWorkshop'))
```
<br/>
```{r, out.width='80%', fig.align='center', fig.cap='Figure 2. Open and closed chromatin.', echo = FALSE}
knitr::include_graphics(system.file('vignettes', 'Fig.2.png', package = 'ATACseqQCWorkshop'))
```
<br/>
...
knitr::include_graphics(system.file('vignettes', 'Fig.3.png', package = 'ATACseqQCWorkshop'))
```
<br/>

```{r, out.width='80%', fig.align='center', fig.cap='Figure 4. Schematic showing of ATAC-seq library preparation.', echo = FALSE}
knitr::include_graphics(system.file('vignettes', 'Fig.4.png', package = 'ATACseqQCWorkshop'))
```
<br/>
...
knitr::include_graphics(system.file('vignettes', 'Fig.5.png', package = 'ATACseqQCWorkshop'))
```
<br/>
...
knitr::include_graphics(system.file('vignettes', 'Fig.6.png', package = 'ATACseqQCWorkshop'))
```
<br/>
...
knitr::include_graphics(system.file('vignettes', 'Fig.7.png', package = 'ATACseqQCWorkshop'))
```
<br/>
...
knitr::include_graphics(system.file('vignettes', 'Fig.9.png', package = 'ATACseqQCWorkshop'))
```
<br/>
