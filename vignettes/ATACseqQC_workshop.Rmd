...
knitr::include_graphics(system.file('vignettes', 'Figure 2. Open and closed chromatin.png', package = 'ATACseqQCWorkshop'))
```
<br/>
...
knitr::include_graphics(system.file('vignettes', 'Figure 3. Chromatin accessibility.png', package = 'ATACseqQCWorkshop'))
```
<br/>

```{r, out.width='80%', fig.align='center', fig.cap='Figure 4. Schematic showing of ATAC-seq library preparation.', echo = FALSE}
knitr::include_graphics(system.file('vignettes', 'Figure 4. Library preparation.png', package = 'ATACseqQCWorkshop'))
```
<br/>
...
knitr::include_graphics(system.file('vignettes', 'Figure 5. QC steps in ATAC-seq.png', package = 'ATACseqQCWorkshop'))
```
<br/>
...
## ATACseqQC workflow
***
In this workshop we will start with preprocessed alignment files in the BAM formats and use the package ATACseqQC to perform some representative steps of post-alignment QC. 
...
knitr::include_graphics(system.file('vignettes', 'Figure 6. Fragments generated by Tn5 tagmentation in ATAC-seq.png', package = 'ATACseqQCWorkshop'))
```
<br/>
...
knitr::include_graphics(system.file('vignettes', 'Figure 7. Library insert size distribution.png', package = 'ATACseqQCWorkshop'))
```
<br/>
...
knitr::include_graphics(system.file('vignettes', 'Figure 9. Nucleosome density distr. around TSS and TFBS.png', package = 'ATACseqQCWorkshop'))
```
<br/>
