...
Task 5. visualize signal distribution along genomic regions of genes "SPTL3", "CRLS1", and "NEFLCD", using the function `IGVSnapshot` and the 4 subsetted, filtered BAM files.
